...
fun TipTimeLayout() {
    ...
    Column(
        ...
        RoundTheTipRow(roundUp, {roundUp = it}, Modifier.padding(bottom = 32.dp))
        Text(
...
fun EditNumberField(
    ...
    TextField(
        value = value, //text box displaying nothing,
        leadingIcon = { Icon(painter = painterResource(id = leadingIcon), null)},
        onValueChange = onValueChange, //lambda callback when enter text
        modifier = modifier,
