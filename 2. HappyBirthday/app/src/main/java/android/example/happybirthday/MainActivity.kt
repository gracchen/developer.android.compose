...
import android.example.happybirthday.ui.theme.HappyBirthdayTheme
...
fun GreetingImage(message: String, from: String, modifier: Modifier = Modifier) {
    val image = painterResource(R.drawable.androidparty) //fetch image
    Box {
        Image(
        ...
        GreetingText(stringResource(R.string.happy_birthday_text), stringResource(R.string.signature_text)
            ,modifier = Modifier
                .fillMaxSize()
                .padding(8.dp)
        )
